...
public class SwingRMes extends JFrame implements ActionListener
{
	...
	static String y="";
	static String str6,str61,str2,str12,str13 , EncryptedData, sendername, recivername;
		...
		try
			{
				...
				str6 = ps2.readLine();
				str6=str6.trim();
				System.out.println("SenderDomainName   : " +str6);
				str61 = ps2.readLine();
				str61=str61.trim();
				System.out.println("ReceiverDomainName : " +str61);
                                sendername = ps2.readLine();
                                sendername=sendername.trim();
				System.out.println("SenderName   : " +sendername);
				recivername = ps2.readLine();
				recivername=recivername.trim();
				System.out.println("ReceiverName : " +recivername);
                                EncryptedData = ps2.readLine();
				...
				String t,st="",st1="";
					    ...
					    ///changed 2 ad 12  /*   Converting Hexcode into Bits    */
								...
								for(i=0;i<len;i++)
								{
									char aa= ((EncryptedData).charAt(i));
									a[i]=aa;
									if(a[i]=='A')
									{
						 				st="1010";
								...
								try
								{
									if(len==1)
									{
										...
										vj=vj+(char)c;
                                                                                System.out.println("VJIHDIUSGHD"+vj);
